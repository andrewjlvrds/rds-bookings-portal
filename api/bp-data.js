...
export default async function(req, res) {
  ...
  try {
    ...
    var bookingFields = [
      ...
      'Lodge_Currency','Booking_Reference','Booking_Notes',
      'Lodge','Tour',
      'RDS_Reference','Lodge_Reference','Enquiry_Sent_Date','Last_Response_Date',
      'Excursion','Excursion_booking_status','Excursion_Date','Excursion_notes',
